...
% \usepackage[style=authoryear-unisa,terseinits=true,backend=biber,datamodel=corp,citecounter,citetracker,maxcitenames=3]{biblatex}
...
\textcite[86]{LIBOR2012} highlights yadda yadda \parencite[86]{LIBOR2012}
...
\textcite[18]{HREOC1997} recommended\textelp{}\\\\but to test the rules, we must also cite \parencite{HREOC1998}
...
% \textcite[152]{LongmanDict} defines\textelp{}\\
