...
\iftoggle{unisasep}{%
	...
	\setkomafont{chapter}{\sffamily\bfseries\changefontsizes{14}\baselineskip=10pt\parskip=7pt}%
	\setkomafont{section}{\sffamily\bfseries\changefontsizes{12}\baselineskip=8pt\parskip=1pt}%
	\setkomafont{subsection}{\sffamily\changefontsizes{12}}%
	\setkomafont{subsubsection}{\usekomafont{subsection}}%
	\setkomafont{paragraph}{\usekomafont{subsection}}%
	\setkomafont{subparagraph}{\usekomafont{subsection}}%
}{%
	%\komafont{chapter}{\sffamily\bfseries}%
}
...
% 	\ \par\ \par\ \par\ \par\ \par
% 	%\vskip{3cm}
% 	{\changefontsizes{16}\bfseries\rmfamily
% 	\@publishers
% 	\par\ \par\ \par
% 	}
% 	{\textbf\rmfamily\changefontsizes{20}\bfseries\rmfamily \@subject\par\ \par\ \par\ \par	\@title\par\changefontsizes{18}\@subtitle}
% 	\ \par\ \par\ \par\ \par
% 	{\changefontsizes{14}{\bfseries Name: }Author\par\ \par\ \par\ \par	Date 
% 	}
% \end{center}
% \makeatother
% \end{titlepage}
